...
public class Tester {
	...
	public static void simpleCase() {
		...
		// start battle
		if (okToStart) {
			System.out.println("@ Welcome to turn-based battle game simulation.");
	...
	public static void bonusCredit() {
		...
		/*
		 * In order to earn bonus credits, you need to configure the players of your
		 * team (Team A) so that your team wins the battle against the instructors' team
		 * (Team B).
		 */
